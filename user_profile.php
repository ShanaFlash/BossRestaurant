...
<head>
    ...
    <title>Boss Smart Restaurant | User Profile</title>
    <!-- Bootstrap core CSS -->
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <a href="edit_userprofile.php"><button class="btn btn-primary">Edit your profile</button></a>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="card mb-3">
                <div class="card-body">
                  <div class="row">
                    ...
                    ?>
                      <?php echo $_SESSION['f_name']; echo $_SESSION['l_name'] ;?>
                    </div>
                  </div>
                  <hr>
                  <div class="row">
